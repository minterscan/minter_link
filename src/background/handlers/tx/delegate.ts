...
// Tx.Delegate
export async function handleTxDelegate (message: Letter): Promise<AxiosResponse|undefined> {
  ...
  return handleTx(txData, TX_TYPE.DELEGATE, message.body.payload, data.gasCoin)
}
